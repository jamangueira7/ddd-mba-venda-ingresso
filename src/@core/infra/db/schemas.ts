...
import { EventSection } from 'src/@core/events/domain/entities/event-section';
import { EventSectionIdSchemaType } from './types/event-section-id.schema-type';
import { EventSpot } from 'src/@core/events/domain/entities/event-spot';
...
import { Order, OrderStatus } from 'src/@core/events/domain/entities/order.entity';
